        ...
        <main class="main">
            <article class="article">
                ...
                <form action="<%=request.getContextPath()%>/ficha08" method="post" class="form">
                    ...
                    <p class="descricao">Selecione o país da instituição depositária.</p>
                    ...
                    <p class="descricao">Selecione a moeda original em que está referenciado o depósito. Será com base nessa mesma moeda que deverão ser informados os demais valores nesta ficha.</p>
                    ...
                    <div class="label-container">
                        <label for="valor">Saldo na data-base: <span class="asterisco">*</span></label>
                    </div>
                    <div class="box-moedas">
                        <div class="simbolo-moedas"> ${ficha.getMoeda().getSimbolo()}</div>
                        <input class="input-moedas" type="text" name="valor" required id="saldo" placeholder="Digite um valor maior ou igual a 0" pattern="^(?!.*[.,]$)(?!^[.,])(?!.*[.,]{3})(\d+(\.\d+)*)(,\d+)?$" value="${numeroUtils.doubleToString(ficha.getSaldoDatabase())}">
                    </div>
                    ...
                    <div class="label-container">
                        <label for="justificativa_gestor">Justificativa do Gestor: <span class="asterisco">*</span></label>
                    </div>
